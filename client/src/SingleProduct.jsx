...
const SingleProduct = () => {
  ...
  const { getSingleProducts, isSingleLoading, singleproducts } = useProductContext();
      ...
      <Container className="container">
        <div className="grid grid-two-column">
          ...
          <div className="product-data">
            ...
            <hr />
            {stock > 0 && <AddToCart products={singleproducts} cartContext={ cartContext } />}
          </div>
        </div>
      </Container>
    </Wrapper>
